...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-1 text-gray-800">أدوات الألوان</h1>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">أدوات مخصصة للألوان</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">أدوات لتخصيص حجم الخط</h6>
                </div>
                <div class="card-body">
